        ...
        <div className="w-full h-[550px] text-white">
            <div className='w-full h-full'>
                ...
                <div className='absolute w-full top-[25%] p-4 md:p-8'>
                    ...
                    <div className="my-4">
                        <button className='border rounded bg-gray-300 text-black border-gray-300 px-5 py-2'>Play</button>
                        <button className='border rounded text-white border-gray-300 px-5 py-2 ml-4'>Watch later</button>
                    </div>
